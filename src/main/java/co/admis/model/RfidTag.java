...
public class RfidTag implements Serializable{
    ...
    public RfidTag(String epc, String barcode, int productCode, int facilityId, String adminUsername, String status) {
        this.epc = epc;
    ...
    public String toString() {
        return "RfidTag{" + "epc=" + epc + ", barcode=" + barcode + ", productCode=" + productCode + ", facilityId=" + facilityId + ", adminUsername=" + adminUsername + ", status=" + status + ", invoiceId=" + invoiceId + '}';
    }
