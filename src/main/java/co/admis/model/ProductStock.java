...
public class ProductStock implements Serializable{
    ...
    public ProductStock(int id, ProductStockRecord productStockRecord, int quantity) {
        this.id = id;
        this.productCode = productStockRecord.getProductCode();
        this.productImageUrl = productStockRecord.getProductImageUrl();
        this.productName = productStockRecord.getProductName();
        this.packing = productStockRecord.getPacking();
        this.manufacturer = productStockRecord.getManufacturer();
        this.scheduledDrug = productStockRecord.getScheduledDrug();
        this.date = productStockRecord.getDate();
        this.price = productStockRecord.getPrice();
        this.tax = productStockRecord.getTax();
        this.discount = productStockRecord.getDiscount();
        this.finalPrice = productStockRecord.getFinalPrice();
        this.purchasePrice = productStockRecord.getPurchasePrice();
        this.purchaseMrp = productStockRecord.getPurchaseMrp();
        this.purchaseTax = productStockRecord.getPurchaseTax();
        this.finalPurchasePrice = productStockRecord.getFinalPurchasePrice();
        this.quantity = quantity;
        this.size = productStockRecord.getSize();
        this.color = productStockRecord.getColor();
        this.brand = productStockRecord.getBrand();
        this.hsn = productStockRecord.getHsn();
        this.adminUsername = productStockRecord.getAdminUsername();
        this.facilityId = productStockRecord.getFacilityId();
        this.userId = productStockRecord.getUserId();
        this.vendorName = productStockRecord.getVendorName();
        this.facilityName = productStockRecord.getFacilityName();
    }

    public ProductStock(int id, String productCode, String productImageUrl, String productName, String packing, String manufacturer, String scheduledDrug, String date, double price, double tax, double discount, double finalPrice, double purchasePrice, double purchaseMrp, double purchaseTax, double finalPurchasePrice, int quantity, String size, String color, String brand, String hsn, String adminUsername, int facilityId, int userId, String vendorName, String facilityName) {
        this.id = id;
    ...
    public ProductStock(ProductStock productStock) {
        ...
        this.date = productStock.getDate();
        ...
        this.adminUsername = productStock.getAdminUsername();
        this.facilityId = productStock.getFacilityId();
        this.userId = productStock.getUserId();
        this.vendorName = productStock.getVendorName();
        this.facilityName = productStock.getFacilityName();
    }
