...
function populateStatesSelected( countryElementId, stateElementId, selectedState ){
	console.log(countryElementId+" "+stateElementId);
	var selectedCountryIndex = document.getElementById( countryElementId ).selectedIndex;
        if(selectedCountryIndex == 0){
            selectedCountryIndex = 105;
        }
...
function populateCountries(countryElementId, stateElementId){
	...
	countryElement.options[0] = new Option(country_arr[104],country_arr[104]);
