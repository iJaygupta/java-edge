                                                        ...
                                                        <div class="table-wrap">
                                                            <div class="table-responsive">
                                                                <table id="datable_1" class="table table-hover display  pb-30" >
                                                                    ...
                                                                    <tbody>
                                                                        <c:forEach items="${admins}" var="list"  varStatus="theCount">
                                                                            <tr>
                                                                                <td><span class="txt-dark weight-500">${theCount.count}</span></td>
                                                                                <td><span class="txt-dark weight-500">${list.username}</span></td>
                                                                                <td><span class="txt-dark weight-500">${list.name}</span></td>
                                                                                <td><span class="txt-dark weight-500">${list.email}</span></td>
                                                                                <td><span class="txt-dark weight-500">${list.number}</span></td>
                                                                                <td><span class="label label-success">${list.status}</span></td>
                                                                                <td><span class="txt-dark weight-500">${list.organizationId}</span></td>
                                                                                <td><span class="txt-dark weight-500">${list.registerDate}</span></td>
                                                                                <td><a href="${ServerConfiguration.LOCAL_URL}/master/admin/admin-edit?username=${list.username}" class="label"><i class="fa fa-2x fa-edit"></i></a></td>
                                                                            </tr>
                                                                        </c:forEach>
                                                                    </tbody>
                                                                </table>
