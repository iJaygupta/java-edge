...
<html lang="en">
	...
	<body>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">edit-organization</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							...
							<li class="active"><span>edit-organization</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
                                                ...
                                                <div class="panel panel-default card-view">
                                                    <div class="panel-wrapper collapse in">
                                                        <div class="panel-body">
                                                            <div class="form-wrap">
                                                                <form action="${ServerConfiguration.LOCAL_URL}/master/updateOrganization" method="POST" id="update-organization-form">
                                                                    <input type="text" name="id" value="${organization.id}" hidden>
                                                                    <h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-calendar-note mr-10"></i>general info</h6>
                                                                    <hr class="light-grey-hr"/>
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="name" value="${organization.name}" class="form-control" placeholder="Organization Name" required>
                                                                                </div>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                        <input type="text" name="email" value="${organization.email}" class="form-control" placeholder="Email" required>
                                                                                </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                        <input type="text" name="phone" value="${organization.phone}" class="form-control" placeholder="Number" required>
                                                                                </div>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                        <input type="text" name="customerIdPrefix" value="${organization.customerIdPrefix}" class="form-control" placeholder="Customer Id Prefix" required>
                                                                                </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group">
                                                                                <input type="number" name="facilityLimit" value="${organization.facilityLimit}" class="form-control" placeholder="Facility Limit" min="1" required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                            <div class="form-group">
                                                                                <input type="number" name="userLimit" value="${organization.userLimit}" class="form-control" placeholder="User Limit" min="1" required>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    <select name="shareFacility" class="form-control" required>
                                                                                        <option <c:if test="${organization.shareFacility == 0}">selected</c:if> value="0">Do not share facility data</option>
                                                                                        <option <c:if test="${organization.shareFacility == 1}">selected</c:if> value="1">Share facility data</option>
                                                                                    </select> 
                                                                                </div>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    <select name="combineFacilityInvoice" class="form-control" required>
                                                                                        <option <c:if test="${organization.combineFacilityInvoice == 0}">selected</c:if> value="0">Use different invoice number sequence for each facility</option>
                                                                                        <option <c:if test="${organization.combineFacilityInvoice == 1}">selected</c:if> value="1">Use same invoice number sequence for all facility</option>
                                                                                    </select> 
                                                                                </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    <select name="ipEnable" class="form-control" required>
                                                                                        <option <c:if test="${organization.ipEnable == 0}">selected</c:if> value="0">Disable ip whitelist</option>
                                                                                        <option <c:if test="${organization.ipEnable == 1}">selected</c:if> value="1">Enable ip whitelist</option>
                                                                                    </select> 
                                                                                </div>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                                <div class="form-group">
                                                                                    <select name="role" class="form-control">
                                                                                        <c:forEach items="${roles}" var="list">
                                                                                             <c:if test="${organization.role == list.role}">
		...
		<script src="${cp}/admin/dist/js/init.js"></script>
                ...
                <!--Ajax-->
                <script src="${cp}/ajax/master/update.organization.js"></script>
