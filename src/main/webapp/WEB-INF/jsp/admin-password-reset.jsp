<%-- 
    ...
    Created on : 4 Nov, 2018, 11:54:03 PM
...
<body class="fix-header fix-sidebar">
                    ...
                    <div class="col-lg-4">
                        <div class="login-content card">
                            <div class="login-form" id="resetPassword">
                                ...
                                <hr>
                                <form id="admin-otp-form" action="/LaboratoryInformationSystem/sendAdminOTP">
                                    <div class="form-group">
                                        ...
                                        <label>Email</label>
                                        <input name="email" type="email" class="form-control" placeholder="Enter your registred email address.">
                                    </div>
                                    <button id="submit-btn" type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30">GET OTP</button>
                                </form>
                            </div> 
                        </div>
                    </div>
    ...
    <!--Ajax-->
    <script src="${cp}/ajax/admin/send.admin.otp.js"></script>
