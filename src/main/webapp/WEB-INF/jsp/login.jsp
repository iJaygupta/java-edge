	...
	<body>
		...
		<div class="wrapper pa-0">
			<header class="sp-header">
                            <a style="float: right;" class="btn btn-danger" href="${ServerConfiguration.LOCAL_URL}/register">Register</a>     
                            <div class="sp-logo-wrap pull-left">
                                <a href="${ServerConfiguration.LOCAL_URL}/index">
		...
		<script src="${cp}/admin/dist/js/init.js"></script>
                ...
                <!--JSP-->
                <%@include file="include/firebase-config.jsp" %>
	</body>
