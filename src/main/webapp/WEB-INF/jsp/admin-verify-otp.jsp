<%-- 
    Document   : admin-verify-otp
    Created on : 5 Nov, 2018, 9:21:09 AM
...
<body class="fix-header fix-sidebar">
                    ...
                    <div class="col-lg-4">
                        <div class="login-content card">
                            <div class="login-form">
                                ...
                                <hr>
                                <form action="/LaboratoryInformationSystem/verifyAdminOTP" id="otpForm">
    ...
    <!--Ajax-->
    <script src="${cp}/ajax/admin/verify.admin.otp.js"></script>
