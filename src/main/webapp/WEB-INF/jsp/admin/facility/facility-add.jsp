...
<html lang="en">
	...
	<body>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">add-facility</h5>
						</div>
						<!-- Breadcrumb -->
                                                ...
                                                <div class="panel panel-default card-view">
                                                    <div class="panel-wrapper collapse in">
                                                        <div class="panel-body">
                                                            <div class="form-wrap">
                                                                <form id="add-facility-form" action="${ServerConfiguration.LOCAL_URL}/admin/facility/addNewFacility">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" name="facilityName" placeholder="Enter facility name" required>
                                                                                </div>
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                                <div class="form-group">
                                                                                        <input type="text" class="form-control" name="facilityCode" placeholder="Enter facility code">
                                                                                </div>
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" name="facilitySupervisorName" placeholder="Enter supervisor name" required>
                                                                                </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-sm-3">
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" name="number" placeholder="Enter facility contact number"> 
                                                                                </div>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                                <div class="form-group">
                                                                                    <input type="email" class="form-control" name="email" placeholder="Enter facility email">
                                                                                </div>
                                                                        </div>
                                                                        <div class="col-sm-3">
                                                                                <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                                <div class="form-group">
                                                                                    <input type="text" class="form-control" name="facilityWebsite" placeholder="Enter facility website">
                                                                                </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                <input type="text" class="form-control" name="facilityCity" placeholder="Enter facility city name"> 
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                <input type="text" class="form-control" name="facilityAddress" placeholder="Enter facility shop no and street name"> 
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-4">
                                                                            <div class="form-group">
                                                                                <input type="text" class="form-control" name="facilityPin" placeholder="Enter facility area pin code">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                                            <div class="form-group">
                                                                                <input type="text" class="form-control" name="facilityLatitude" placeholder="Facility latitude">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-2">
                                                                            <div class="form-group">
                                                                                <input type="text" class="form-control" name="facilityLongitude" placeholder="Facility longitude">
                                                                            </div>
                                                                        </div>
                                                                    </div>
		...
		<script src="${cp}/admin/dist/js/init.js"></script>
                ...
                <!--Ajax-->
                <script src="${cp}/ajax/admin/facility/add.facility.js"></script>
