<%-- 
    Document   : login
    Created on : 13 Jul, 2018, 10:23:55 PM
    Author     : JAY
--%>
...
<body class="fix-header fix-sidebar">
                    ...
                    <div class="col-lg-4">
                        <div class="login-content card">
                            <div class="login-form">
                                ...
                                <form action="/user/userLogin" id="user-login-form">
                                    <div class="form-group">
                                        <label>Number</label>
                                        <input type="number" class="form-control" placeholder="Number" name="username" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="checkbox">
                                        ...
                                        <label class="pull-right">
                                            <a href="/user-password-reset">Forgotten Password?</a>
                                        </label>
                                    </div>
    ...
    <!--Login Ajax-->
    <script src="${cp}/ajax/user/user.login.js"></script>
